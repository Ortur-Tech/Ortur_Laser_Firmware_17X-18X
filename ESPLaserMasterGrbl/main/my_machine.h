...
#define ORTUR_FW_VERSION_NUM 175
#define ORTUR_FW_VERSION "175"
#elif BOARD_VERSION == OLM_ESP_PRO_V1X
#define ORTUR_FW_VERSION_NUM 187
#define ORTUR_FW_VERSION "187"
#elif BOARD_VERSION == OCM_ESP_PRO_V1X
#define ORTUR_FW_VERSION_NUM 240
#define ORTUR_FW_VERSION "240"
#else
#define ORTUR_FW_VERSION_NUM 250
#define ORTUR_FW_VERSION "250"
#endif
...
#define ORTUR_MODEL_NAME "Aufero 2 S2"
#elif (MACHINE_TYPE == AUFERO_1)
#define ORTUR_MODEL_NAME "Aufero 1 S2"
...
#define ORTUR_MODEL_NAME "Aufero CNC"
#else
#error "错误的机型！！"
#endif
