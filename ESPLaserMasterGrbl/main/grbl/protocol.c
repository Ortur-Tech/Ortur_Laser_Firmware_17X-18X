...
#if (MACHINE_TYPE == OLM2) || MACHINE_TYPE == OLM2_S2 ||MACHINE_TYPE == OLM2_PRO_S1 || MACHINE_TYPE == OLM2_PRO_S2_MAX || MACHINE_TYPE == OLM2_PRO_S2 ||  MACHINE_TYPE == OLM_PRO || (MACHINE_TYPE == AUFERO_1)
#ifndef COREXY
	  	  memcpy(line,"$H\0",3);
		  report_status_message(system_execute_line(line));
#endif
