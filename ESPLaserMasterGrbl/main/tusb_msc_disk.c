...
// FAT magic code at offset 510-511
		{ 0xEB, 0x3C, 0x90, 0x4D, 0x53, 0x44, 0x4F, 0x53, 0x35, 0x2E, 0x30,
				...
				0x56, 0x78,
#if (MACHINE_TYPE == OLM2_PRO_S1) || MACHINE_TYPE == OLM2_PRO_S2_MAX || (MACHINE_TYPE == OLM2_PRO_S2) || (MACHINE_TYPE == OLM_PRO) || (MACHINE_TYPE == OLM2_S2) || (MACHINE_TYPE == OLM2)
				'O', 'r', 't', 'u', 'r', ' ', 'L', 'a', 's', 'e', 'r',
...
#if (MACHINE_TYPE == OLM2_PRO_S2) || MACHINE_TYPE == OLM2_PRO_S2_MAX || (MACHINE_TYPE == OLM2_PRO_S1) || (MACHINE_TYPE == OLM_PRO) || (MACHINE_TYPE == OLM2_S2) || (MACHINE_TYPE == OLM2)
				'O', 'r', 't', 'u', 'r', ' ', 'L', 'a', 's', 'e', 'r',
#elif (MACHINE_TYPE == AUFERO_1) || (MACHINE_TYPE == AUFERO_2)
				'A', 'u', 'f', 'e', 'r', 'o', 'L', 'a', 's', 'e', 'r',
#else
